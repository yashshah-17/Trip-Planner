...
/*    $username=$_SESSION['myValue'];
    ...
    mysqli_query($conn,"INSERT INTO it_details (ID,Day,Source,Destination,Comment,Rating,Stay) VALUES ('".$id."','".$i."','".$source."','".$destination."','".$comment."','".$rating."','".$stay."')");

    $_SESSION['i']=$i+1;

    if($n-$i===0)
    {
        header("Location: it_display.php");
    }
    else
    {
